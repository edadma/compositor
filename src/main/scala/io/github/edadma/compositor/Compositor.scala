...
//  loadFont("pragati", "PragatiNarrow/PragatiNarrow-Bold.ttf", "bold")
  loadFont("playfairsc", "PlayfairDisplaySC/PlayfairDisplaySC-Regular.ttf")
  loadFont("playfairsc", "PlayfairDisplaySC/PlayfairDisplaySC-Italic.ttf", "italic")
  loadFont("playfairsc", "PlayfairDisplaySC/PlayfairDisplaySC-Bold.ttf", "bold")
