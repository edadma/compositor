...
//  val doc = Compositor.png("test.png", 1280, 720, ppi(1920, 1080, 13), simplePage(Some(Color(0x19, 0x25, 0x40, 255))))
  ...
  doc.size(8)
  doc add doc.charBox("[line 4]")
//  doc.prefixSup("12", "asdf")
//  doc addText "As I walked through the"
//  doc.bold()
//  doc addBox new FrameBox(doc.textBox("wilderness")) { background = Color("orange"); leftPadding = 2; rightPadding = 2 }
//  doc.nobold()
...
//////  doc.paragraph()
//  doc.startPage(new SimplePage(200))
